...
public class ServiceTest extends BaseTestCase {
	...
	public void setUp() {
		...
		service.getUpdateManager().setCheckOption( ServiceUpdateManager.CheckOption.DISABLED );
	}
	...
	public void testAlreadyRunning() throws Exception {
		...
		service1.getUpdateManager().setCheckOption( ServiceUpdateManager.CheckOption.DISABLED );
		...
		service2.getUpdateManager().setCheckOption( ServiceUpdateManager.CheckOption.DISABLED );
